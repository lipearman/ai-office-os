...
## Checks
- Frontend types: `cd frontend && npm run type-check` (should be **clean / 0 errors**). The old Three.js office (`components/office/*` drei/fiber cluster) was removed — the office is Phaser-only (`components/phaser/`, `components/office/TradingOffice.tsx`).
